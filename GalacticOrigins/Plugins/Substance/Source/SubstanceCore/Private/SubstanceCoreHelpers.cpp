...
void UpdateSubstanceOutput(USubstanceTexture2D* Texture, const SubstanceTexture& ResultText)
{
	...
	Texture->Format = Substance::Helpers::SubstanceToUe4Format((SubstancePixelFormat)ResultText.pixelFormat);
...
EPixelFormat SubstanceToUe4Format(const SubstancePixelFormat Format)
{
